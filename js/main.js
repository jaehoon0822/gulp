...
"use strict";var _util=require("./util"),rOne=(0,_util.random)(10),rTwo=(0,_util.random)(20),rThree=(0,_util.random)(30);console.log("".concat(rOne," ").concat(rTwo," ").concat(rThree));
